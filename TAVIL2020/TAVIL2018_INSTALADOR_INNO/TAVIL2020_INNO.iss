...
DisableDirPage=yes
DefaultGroupName=2aCAD Global Group\TAVIL2020
DisableProgramGroupPage=yes
OutputDir="{srcexe}\..\SALIDA"
OutputBaseFilename=TAVIL2020_v{#MyAppVersion}
...
VersionInfoDescription=TAVIL2020. Administración de planos de Layout
VersionInfoCopyright=Copyright © Jose Alberto Torres (2aCAD Global Group  2020)
VersionInfoProductName=TAVIL2020
...
Name: "{group}\TAVIL2020"; Filename: "{app}"; WorkingDir: "{app}"; IconFilename: "{app}"
...
[Registry]
Root: "HKCU"; Subkey: "Software\Autodesk\AutoCAD\R22.0\ACAD-0001:40A\Profiles\<<Perfil sin nombre>>\Variables"; ValueType: string; ValueName: "TRUSTEDPATHS"; ValueData: "C:\\ProgramData\\Autodesk\\ApplicationPlugins\\TAVIL2020.bundle"; Flags: createvalueifdoesntexist uninsclearvalue; Permissions: everyone-full
Root: "HKLM"; Subkey: "SOFTWARE\Autodesk\AutoCAD\R22.0\ACAD-1001\Variables\TRUSTEDPATHS"; ValueType: string; ValueName: "@"; ValueData: "C:\\ProgramData\\Autodesk\\ApplicationPlugins\\TAVIL2020.bundle"; Flags: uninsclearvalue createvalueifdoesntexist
